...
import com.example.Backend.exception.UserAlreadyEnrolledException;
...
public class UserServiceImpl implements UserService{
    ...
    public String exchangeUserSecretForToken(String userSecret) {
        ...
        User user = (User) userRepository.findByUseSecret(userSecret).orElseThrow(() -> new RuntimeException("Invalid user secret"));
    ...
    @Override
    public void switchOfflinePayements(String userId, boolean enable, LocalDateTime currentDateTime, Double latitude, Double longitude) {
        ...
        if (enable) {
            ...
            user.setOfflinePaymentsEnabled(false);
            user.setOfflinePaymentsDisabledTime(currentDateTime);
