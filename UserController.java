...
import com.example.Backend.dto.ExchangeTokenDTO;
...
public class UserController {
    ...
    public ResponseEntity<String> switchOfflinePayments(
        ...
        userService.switchOfflinePayements(userId, enable, currentDateTime, enable ? latitude : null, enable ? longitude : null);
